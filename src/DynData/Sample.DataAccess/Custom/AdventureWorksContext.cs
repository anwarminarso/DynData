...
namespace Sample.DataAccess
{
    ...
    {
        public AdventureWorksContext(DatabaseServer DBSetting)
            : base(DBSetting)
        {
        }
        public static void Open(DatabaseServer DBSetting, Action<AdventureWorksContext> action)
        {
            using (AdventureWorksContext db = new AdventureWorksContext(DBSetting))
            {
                action(db);
            }
        }
