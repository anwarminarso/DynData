...
{
    public partial class AdvWorksDbContext : DynDbContext
    {
        public AdvWorksDbContext(DatabaseServer DBSetting)
            : base(DBSetting)
        {
        }
        public static void Open(DatabaseServer DBSetting, Action<AdvWorksDbContext> action)
        {
            using (AdvWorksDbContext db = new AdvWorksDbContext(DBSetting))
            {
                action(db);
            }
        }
        ...
        protected void SqlServerModelCreating(ModelBuilder modelBuilder)
        {
